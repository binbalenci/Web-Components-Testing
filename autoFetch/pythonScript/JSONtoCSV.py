...
frame.to_csv('%s%s.csv' % (directoryPath, fileName), index=False, columns=[
    'repo', 'description', 'owner', 'version', 'updated_at', 'stars', 'forks', 'screenshot_url', 'samplecode_url', 'supported_browsers', 'rating', 'comment'])
